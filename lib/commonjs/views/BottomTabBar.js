...
class TouchableWithoutFeedbackWrapper extends _react.default.Component {
  render() {
    ...
    }, /*#__PURE__*/_react.default.createElement(_reactNative.View, rest));
  }

}

class TabBarBottom extends _react.default.Component {
  constructor(...args) {
    super(...args);
    ...
    _defineProperty(this, "_handleKeyboardShow", () => {
      this.setState({
        ...
        _reactNative.Animated[animation](this.state.visible, _objectSpread({
          toValue: 0
        }, config)).start();
      });
    });
    ...
    _defineProperty(this, "_renderIcon", ({
      ...
      return /*#__PURE__*/_react.default.createElement(_CrossFadeIcon.default, {
        route: route,
  ...
  render() {
    ...
    const _StyleSheet$flatten = _reactNative.StyleSheet.flatten(style || {}),
          {
      position,
      top,
      left = 0,
    ...
    }, /*#__PURE__*/_react.default.createElement(_reactNativeSafeAreaView.default, {
      style: tabBarStyle,
